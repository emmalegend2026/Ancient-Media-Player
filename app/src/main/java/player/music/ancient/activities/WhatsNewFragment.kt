...
import player.music.ancient.util.ATHUtil.isWindowBackgroundDark
import player.music.ancient.util.ColorUtil.isColorLight
import player.music.ancient.util.ColorUtil.lightenColor
import player.music.ancient.util.MaterialValueHelper.getPrimaryTextColor
import player.music.ancient.BuildConfig
import player.music.ancient.Constants
import player.music.ancient.databinding.FragmentWhatsNewBinding
import player.music.ancient.extensions.accentColor
import player.music.ancient.extensions.openUrl
import player.music.ancient.util.PreferenceUtil.lastVersion
...
open class WhatsNewFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val stream = requireContext().assets.open("ancient-changelog.html")
